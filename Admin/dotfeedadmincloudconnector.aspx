...
<asp:Content runat="server" ContentPlaceHolderID="bodyContentPlaceholder">
	...
	<asp:Panel ID="Disconnected" runat="server" Visible="false">
		<iframe src="http://www.aspdotnetstorefront.com/linkmanager.aspx?topic=9510dotfeed&type=gscrefresh" frameborder="0" style="overflow:hidden;height:90%;width:90%;position:absolute;" height="100%" width="100%"></iframe>
	</asp:Panel>
