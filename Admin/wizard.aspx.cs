...
namespace AspDotNetStorefrontAdmin
{
	public partial class Wizard : AdminPageBase
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			var amazonPrompt = "Limited Time: <a href='{0}' target='_blank'>No Processing Fees</a>";
		...
		public void BuildGatewayList()
		{
			...
			if(repGateways.DataSource == null)
			{
				...
				ds.Add(CreateGatewayData("PayPal Payflow Link", "PayFlowPro", "(also enables PayPal Express Checkout) - See <a href='http://www.aspdotnetstorefront.com/linkmanager.aspx?topic=9510manual&type=paypalpayflowlink' target='_blank'>Manual</a>."));
				ds.Add(CreateGatewayData("PayPal Payments Advanced", "PayFlowPro", "(also enables PayPal Express Checkout) - See <a href='http://www.aspdotnetstorefront.com/linkmanager.aspx?topic=9510manual&type=paypalpaymentsadvanced' target='_blank'>Manual</a>."));
		...
		protected void btnSubmit_Click(object sender, EventArgs e)
		{
			...
			var temp = GetCheckedPaymentMethods();
