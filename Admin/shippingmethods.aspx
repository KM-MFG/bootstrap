<%@ Page Language="c#" Inherits="AspDotNetStorefrontAdmin.ShippingMethods" CodeFile="shippingmethods.aspx.cs" MasterPageFile="~/App_Templates/Admin_Default/AdminMaster.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="bodyContentPlaceholder">
	...
	<aspdnsf:FilteredListing runat="server"
		ID="FilteredListing"
		SqlQuery="select {0} nullif(dbo.GetMlValue(sm.Name, @_locale),'') Name, sm.ShippingMethodID, sm.DisplayOrder from ShippingMethod sm WITH (NOLOCK) WHERE sm.IsRTShipping = 0 and {1}"
