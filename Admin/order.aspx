<%@ Page Language="C#" AutoEventWireup="true" CodeFile="order.aspx.cs" Inherits="AspDotNetStorefrontAdmin.orderdetail" MasterPageFile="~/App_Templates/Admin_Default/AdminMaster.master" ValidateRequest="false" MaintainScrollPositionOnPostback="true" %>
	...
	<div class="main-content-wrapper" id="editOrderWrap">
		...
		<asp:Panel ID="pnlOrderDetails" runat="server" Visible="true">
			<div class="item-action-bar">
				<asp:Button ID="btnEdit" CssClass="btn btn-default" Text="<%$Tokens:StringResource, admin.common.Edit %>" Enabled="false" runat="server" OnClick="btnEdit_Click" />
						...
						<div id="divShippingDeliveryInfo" visible="false" runat="server">
							...
							<div class="row">
								<div class="col-md-9 col-md-offset-3">
									<asp:Button ID="btnSendToShipRush" Enabled="false" runat="server" CssClass="btn btn-primary" OnClick="btnSendToShipRush_Click" />
											...
											<Columns>
												<asp:TemplateField>
													...
													<ItemTemplate>
														...
														<div>
															<asp:Literal runat="server" Text="<%$Tokens:StringResource, admin.orderframe.DownloadExpiredOn %>" />
				...
				<div id="divRightColumn" runat="server" class="col-md-6" visible="true">
					...
					<div id="divPaymentInfo" class="white-ui-box">
						...
						<div>
							...
							<div id="divECheckinInfo" runat="server" visible="false">
								<div class="row">
									<div class="col-md-3">
										<asp:Literal runat="server" Text="<%$Tokens:StringResource, admin.orderframe.ECheckBankName %>" />
									</div>
									<div class="col-md-9">
										<asp:Literal runat="server" ID="litECheckBankName" />
									</div>
								</div>
								<div class="row">
									<div class="col-md-3">
										<asp:Literal runat="server" Text="<%$Tokens:StringResource, admin.orderframe.ECheckABA %>" />
									</div>
									<div class="col-md-9">
										<asp:Literal runat="server" ID="litEcheckABA" />
									</div>
								</div>
								<div class="row">
									<div class="col-md-3">
										<asp:Literal runat="server" Text="<%$Tokens:StringResource, admin.orderframe.ECheckAccount %>" />
									</div>
									<div class="col-md-9">
										<asp:Literal runat="server" ID="litEcheckAccount" />
									</div>
								</div>
								<div class="row">
									<div class="col-md-3">
										<asp:Literal runat="server" Text="<%$Tokens:StringResource, admin.orderframe.ECheckAccountName %>" />
									</div>
									<div class="col-md-9">
										<asp:Literal runat="server" ID="litECheckAccountName" />
									</div>
								</div>
								<div class="row">
									<div class="col-md-3">
										<asp:Literal runat="server" Text="<%$Tokens:StringResource, admin.orderframe.EcheckAccountType %>" />
									</div>
									<div class="col-md-9">
										<asp:Literal runat="server" ID="litEcheckAccountType" />
									</div>
								</div>
							</div>
							...
							<div id="divAmazonInfo" runat="server" visible="false">
								<div class="form-group form-inline">
									<asp:Literal ID="litAmazonManage" Visible="false" runat="server" Text="<%$Tokens:StringResource, gw.checkoutbyamazon.display.2 %>" />
									<asp:Button ID="btnUpdateAmazonTransaction" CssClass="btn btn-primary" runat="server" Text="<%$Tokens:StringResource, admin.orderframe.UpdateTransaction %>" OnClick="btnUpdateAmazonTransaction_Click" />
								</div>
								<asp:Literal runat="server" Text="<%$Tokens:StringResource, admin.orderdetails.AmazonOrders %>" />
								<asp:Literal runat="server" ID="litAmazonOrderIds" />
								<asp:Literal runat="server" Text="<%$Tokens:StringResource, admin.orderdetails.AmazonFeeds %>" />
								<asp:Literal runat="server" ID="litAmazonFeedIds" />
							</div>
						</div>
					</div>
					...
					<div id="divDebugInfo" class="white-ui-box">
						...
						<div id="divTransactionInfoWrap" runat="server" visible="false">
							...
							<div id="divTransactionInfo" style="display: none;">
								...
								<div id="divCardinalParams" runat="server" visible="false">
									<asp:Literal runat="server" Text="<%$Tokens:StringResource, admin.orderframe.CardinalGatewayParms %>" />
									<asp:TextBox TextMode="MultiLine" CssClass="form-control disabled" Rows="4" ID="txtCardinalParams" runat="server" />
								</div>
			...
			<div class="item-action-bar">
				<asp:Button ID="btnEditBottom" CssClass="btn btn-default" Text="<%$Tokens:StringResource, admin.common.Edit %>" Enabled="false" runat="server" OnClick="btnEdit_Click" />
