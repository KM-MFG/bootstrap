<%@ Page Language="C#" AutoEventWireup="true" CodeFile="affiliate.aspx.cs" Inherits="AspDotNetStorefrontAdmin.affiliate" MasterPageFile="~/App_Templates/Admin_Default/AdminMaster.master" %>
					...
					<div class="col-md-4">
						...
						<asp:Panel ID="CreatePasswordRow" runat="server">
							<div class="form-group">
								...
								<asp:Label runat="server" Text="<%$Tokens:StringResource, admin.editAffiliates.PasswordLength %>" />
						...
						<div class="form-group">
							<asp:Label runat="server" Text="<%$Tokens:StringResource, admin.phoneorder.label.Suite %>" />
						...
						<div class="form-group">
							<asp:Label runat="server" Text="<%$Tokens:StringResource, admin.phoneorder.label.State %>" />
						...
						<div class="form-group">
							<asp:Label runat="server" Text="<%$Tokens:StringResource, admin.phoneorder.label.Country %>" />
							<asp:DropDownList ID="ddCountry" runat="server" CssClass="form-control" />
						</div>
						<div class="form-group">
							<asp:Label runat="server" Text="<%$Tokens:StringResource, admin.phoneorder.label.Phone %>" />
