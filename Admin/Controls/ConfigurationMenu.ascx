<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ConfigurationMenu.ascx.cs" Inherits="AspDotNetStorefrontControls.ConfigurationMenu" %>
						...
						<li>
							...
							<ul>
								...
								<li><a href="bmlsettings.aspx">
									<asp:Literal runat="server" Text="<%$Tokens:StringResource, admin.menu.paypalbillmelater %>" /></a></li>
