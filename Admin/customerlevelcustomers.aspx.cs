...
{
	public partial class CustomerLevelCustomers : AdminPageBase
	{
		...
		public static string[] GetCompletionList(string prefixText, int count, string contextKey)
		{
			using(SqlConnection dbconn = DB.dbConn())
			{
                ...
                using (IDataReader rsCustomer = DB.GetRS("SELECT TOP (@count) CustomerId, Email FROM Customer WITH (NOLOCK) WHERE (Email <> '' AND Email LIKE @prefixText) OR FirstName LIKE @prefixText OR LastName LIKE @prefixText OR CustomerId LIKE @prefixText", spa, dbconn))
				{
