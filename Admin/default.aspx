				...
				<div class="tab-content white-ui-box">
							...
							<div class="row">
								<div class="col-sm-12">
									...
									<asp:Panel ID="Panel2" runat="server">
										<aspdnsf:XmlPackage ID="XmlPackage2" runat="server" PackageName="rss.aspdnsfrssconsumer.xml.config" RuntimeParams="channel=sponsors&height=330" />
									</asp:Panel>
								</div>
							</div>
						</div>					
					...
					<div class="tab-pane" id="quick-look-tab" style="height:350px;">
						...
						<div class="form-group">
							...
							<div class="row">
								<div class="col-sm-6">
									<a href="appconfigs.aspx?filter.search=checkout.type">
										<asp:Label runat="server" Text="<%$Tokens:StringResource, admin.dashboard.Checkout %>" />
									</a>
								</div>
								<div class="col-sm-6">
									<asp:Label ID="lblCheckoutType" runat="server" />
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
									<a href="about.aspx">
										<asp:Label runat="server" Text="<%$Tokens:StringResource, admin.dashboard.Security %>" />
									</a>
								</div>
								<div class="col-sm-6">
