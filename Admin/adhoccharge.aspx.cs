...
{
	public partial class adhoccharge : AdminPageBase
	{
				...
				else
				{
					...
					else
					{
						...
						else
						{
							...
							writer.Append("<table class=\"table\">");
							writer.Append("<tr>");
							writer.Append("<td>" + AppLogic.GetString("address.cs.31", ThisCustomer.SkinID, ThisCustomer.LocaleSetting) + "</td>");
							writer.Append("<td>\n");
							...
							if(AppLogic.AppConfigBool("ShowCardStartDateFields"))
							{
								...
								writer.Append("<tr><td align=\"right\">" + AppLogic.GetString("address.cs.61", ThisCustomer.SkinID, ThisCustomer.LocaleSetting) + "</td><td><input type=\"text\" autocomplete=\"off\" name=\"CardIssueNumber\" id=\"CardIssueNumber\" size=\"2\" maxlength=\"2\"> " + AppLogic.GetString("address.cs.63", ThisCustomer.SkinID, ThisCustomer.LocaleSetting) + "</td></tr>");
							}
							writer.Append("</table>");
							writer.Append("</div>");
							writer.Append("</td></tr>");
