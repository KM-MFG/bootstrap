<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product.aspx.cs" Inherits="AspDotNetStorefrontAdmin.ProductEditor" MasterPageFile="~/App_Templates/Admin_Default/AdminMaster.master" %>
				...
				<div class="tab-content white-ui-box">
					...
					<div class="tab-pane" id="extensiondata-tab">
						<div class="form-group">
							<div class="admin-row">
								<div class="col-sm-2">
									<asp:Label ID="lblExtensionData" runat="server" AssociatedControlID="txtExtensionData">Custom Field:</asp:Label>
								</div>
								<div class="col-sm-10">
									<div class="col-sm-7">
										<asp:TextBox ID="txtExtensionData" runat="Server" CssClass="form-control multiExtension" TextMode="multiLine" CausesValidation="false" />
									</div>
								</div>
							</div>
							<div class="admin-row">
