...
{
	public partial class recurringrefundcancel : AdminPageBase
	{
		...
		private void ProcessRefund()
		{
			...
			String refundStatus = Gateway.OrderManagement_DoFullRefund(thisOrder, ThisCustomer.LocaleSetting, refundReason);
		...
		private void CancelRecurringOrder(Order thisOrder)
		{
			...
			var recurringManager = new RecurringOrderMgr(null, null);
