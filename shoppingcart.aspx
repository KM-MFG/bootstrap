	...
	<asp:Panel ID="pnlContent" runat="server">
		<div class="page-wrap shopping-cart-page">
			...
			<div class="page-row row-checkout-controls">
				<div class="one-third page-links">
			...
			<div class="row-alt-checkouts" runat="server" id="divAltCheckoutsTop">
				<div class="page-row">
					<div runat="server" class="paypal-buttons" id="divPayPalExpressTop">
					...
					<div runat="server" class="paypal-buttons" id="divAmazonCheckoutTop">
				...
				<div class="page-row row-shopping-cart">
					<aspdnsfc:ShoppingCartControl ID="ctrlShoppingCart" runat="server"
						...
						<LineItemSettings LinkToProductPageInCart='<%$ Tokens:AppConfigBool, LinkToProductPageInCart %>'
							...
							ShowEditButtonInCartForKitProducts='<%$ Tokens:AppConfigBool, ShowEditButtonInCartForKitProducts %>' ShowMultiShipAddressUnderItemDescription="true" />
			...
			<asp:Panel ID="pnlSubTotals" runat="server">
				...
				<div class="page-row row-request-estimate">
			...
			<div class="row-alt-checkouts" runat="server" id="divAltCheckoutsBottom">
				<div class="page-row">
					<div class="paypal-buttons" runat="server" id="divPayPalExpressBottom">
						<div class="paypal-button">
					...
					<div class="paypal-buttons" runat="server" id="divAmazonCheckoutBottom">
