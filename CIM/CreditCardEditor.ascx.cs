...
public partial class CIM_CreditCardEditor : System.Web.UI.UserControl
{
	...
	protected void ButtonSave_Click(object sender, EventArgs e)
	{
		...
		{
			if(errorCode == "E00039")
				ShowError(AppLogic.GetString("AspDotNetStorefrontGateways.AuthorizeNet.Cim.PaymentProfileAlreadyExists", adnsfCustomer.SkinID, adnsfCustomer.LocaleSetting));
			else
				ShowError(String.Format("{0} {1}", AppLogic.GetString("AspDotNetStorefrontGateways.AuthorizeNet.Cim.ErrorMessage", adnsfCustomer.SkinID, adnsfCustomer.LocaleSetting), errorMessage));
