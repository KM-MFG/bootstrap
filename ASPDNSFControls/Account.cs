...
namespace AspDotNetStorefrontControls
{
    ...
    { 
        ...
        private void AssignDefaults()
        {
			...
			_rfvFirstName.CssClass = "text-danger";
			_rfvLastName.CssClass = "text-danger";
			_rfvEmail.CssClass = "text-danger";
			_rfvReEnterEmail.CssClass = "text-danger";
			_rfvPassword.CssClass = "text-danger";
			_rfvPhone.CssClass = "text-danger";
			_rfvSecurityCode.CssClass = "text-danger";
			_revEmail.CssClass = "text-danger";
			_rfvDOBDay.CssClass = "text-danger";
			_rfvDOBMonth.CssClass = "text-danger";
			_rfvDOBYear.CssClass = "text-danger";
