...
namespace AspDotNetStorefrontGateways.PPSCommerce {
    using System;
    ...
    public partial class SmartPayments : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public SmartPayments() {
            this.Url = global::AspDotNetStorefrontGateways.Properties.Settings.Default.AspDotNetStorefrontGateways_PPSCommerce_SmartPayments;
        ...
        /// <remarks/>
        public System.IAsyncResult BeginProcessCreditCard(
                    string UserName, 
                    string Password, 
                    string TransType, 
                    string CardNum, 
                    ...
                    object asyncState) {
            return this.BeginInvoke("ProcessCreditCard", new object[] {
                        UserName,
                        Password,
                        TransType,
                        CardNum,
                        ...
                        Street,
                        CVNum,
                        ExtData}, callback, asyncState);
        }
        
        /// <remarks/>
        public Response EndProcessCreditCard(System.IAsyncResult asyncResult) {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginProcessDebitCard(
                    string UserName, 
                    string Password, 
                    string TransType, 
                    string CardNum, 
                    ...
                    System.AsyncCallback callback, 
                    object asyncState) {
            return this.BeginInvoke("ProcessDebitCard", new object[] {
                        UserName,
                        Password,
                        TransType,
                        CardNum,
        ...
        /// <remarks/>
        public Response EndProcessDebitCard(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((Response)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginProcessEBTCard(
                    string UserName, 
                    string Password, 
                    string TransType, 
                    string CardNum, 
                    ...
                    System.AsyncCallback callback, 
                    object asyncState) {
            return this.BeginInvoke("ProcessEBTCard", new object[] {
                        UserName,
                        Password,
                        TransType,
                        CardNum,
        ...
        /// <remarks/>
        public Response EndProcessEBTCard(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((Response)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginProcessLoyaltyCard(string UserName, string Password, string TransType, string CardNum, string ExpDate, string MagData, string Amount, string InvNum, string PNRef, string ExtData, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("ProcessLoyaltyCard", new object[] {
                        UserName,
                        Password,
                        TransType,
                        CardNum,
        ...
        /// <remarks/>
        public Response EndProcessLoyaltyCard(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((Response)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginProcessGiftCard(string UserName, string Password, string TransType, string CardNum, string ExpDate, string MagData, string Amount, string InvNum, string PNRef, string ExtData, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("ProcessGiftCard", new object[] {
                        UserName,
                        Password,
                        TransType,
                        CardNum,
        ...
        /// <remarks/>
        public Response EndProcessGiftCard(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((Response)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginProcessCheck(
                    string UserName, 
                    string Password, 
                    string TransType, 
                    string CheckNum, 
                    ...
                    System.AsyncCallback callback, 
                    object asyncState) {
            return this.BeginInvoke("ProcessCheck", new object[] {
                        UserName,
                        Password,
                        TransType,
                        CheckNum,
        ...
        /// <remarks/>
        public Response EndProcessCheck(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((Response)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginGetInfo(string UserName, string Password, string TransType, string ExtData, System.AsyncCallback callback, object asyncState) {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginProcessSignature(string UserName, string Password, string SignatureType, string SignatureData, string PNRef, string Result, string AuthCode, string ExtData, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("ProcessSignature", new object[] {
                        UserName,
                        Password,
                        SignatureType,
                        SignatureData,
        ...
        /// <remarks/>
        public Response EndProcessSignature(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((Response)(results[0]));
        }
