        ...
        <div class="page-wrap affiliate-page">
            ...
            <asp:Panel ID="pnlSignUpForm" runat="server" Visible="false">
                ...
                <div id="tblAffWebInfo" class="form affiliate-web-form" runat="server">
                    ...
                    <div class="form affiliate-website-form" id="tblWebSiteInfoBox" runat="server">
                        <div class="form-text">
                ...
                <div>
					<p class="affiliate-terms-wrap">
						<asp:CheckBox ID="cbkAgreeToTermsAndConditions" runat="server" CausesValidation="true" ValidationGroup="signup" />
						By selecting this box and pressing the "Join" button, I agree to these 
