    ...
    {      
        ...
        protected void rptOrderOptions_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
                ...
                e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                {
                    helpcircle_gif.Attributes.Add("onclick", "popuporderoptionwh('Cart Upsell " + opt.ID.ToString() + "', " + opt.ID.ToString() + ",650,550,'yes');");
                }

				var imgOption = e.Item.FindControl<Image>("imgOption");
				if (imgOption != null && opt.ImageUrl.IndexOf("nopictureicon") == -1)
				{
					imgOption.ImageUrl = opt.ImageUrl;
