<%@ Page Language="C#" AutoEventWireup="true" CodeFile="customer.aspx.cs" Inherits="AspDotNetStorefrontAdmin._customer" MasterPageFile="~/App_Templates/Admin_Default/AdminMaster.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="bodyContentPlaceholder">
	...
	<div id="pnlCustomerEdit" runat="server">
		...
		<asp:Panel runat="server" CssClass="white-ui-box">
			...
			<asp:Panel runat="server" ID="pnlCreateCustomerPassword" CssClass="row form-group" Visible="false">
				...
				<div class="col-sm-3">
					...
					<asp:RegularExpressionValidator Display="Dynamic" ID="regexValTxtCreatePassword" runat="server" ErrorMessage="<%$ Tokens:StringResource, admin.customer.PasswordValidationFailed %>"
						ControlToValidate="txtCreatePassword" ValidationGroup="vldMain" CssClass="text-danger" ValidationExpression="\S{5,}" />
			...
			<div class="row form-group">
				<div class="col-sm-3">
					<asp:Literal runat="server" Text="<%$ Tokens:StringResource, admin.customer.DateOfBirth %>" />
				</div>
				<div class="col-sm-3">
					<telerik:RadDatePicker ID="txtDOB" runat="server" MaxDate="9999-12-31" MinDate="0001-01-01" Width="100%">
			...
			<div class="row form-group">
				<div class="col-sm-3">
					<asp:Literal runat="server" Text="<%$ Tokens:StringResource, admin.customer.CODAllowed %>" />
				</div>
				<div class="col-sm-3">
			...
			<div class="row form-group">
				<div class="col-sm-3">
					<asp:Literal runat="server" Text="<%$ Tokens:StringResource, admin.customer.NetTermsAllowed %>" />
				</div>
				<div class="col-sm-3">
		...
		<asp:Panel runat="server" ID="pnlCustomerTools" Visible="false" CssClass="white-ui-box">
			...
			<div class="row form-group">
				...
				<div class="col-sm-6">
					...
					<asp:RegularExpressionValidator ID="regexValManualPassword" runat="server" ErrorMessage="<%$ Tokens:StringResource, admin.customer.PasswordValidationFailed %>"
