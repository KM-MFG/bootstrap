<%@ Page Language="C#" AutoEventWireup="true" CodeFile="giftcard.aspx.cs" Inherits="AspDotNetStorefrontAdmin.giftcard" MaintainScrollPositionOnPostback="true" MasterPageFile="~/App_Templates/Admin_Default/AdminMaster.master" %>
	...
	<asp:Panel runat="server" CssClass="wrapper" DefaultButton="btnSubmit">
		...
		<div class="white-ui-box">
			<div id="divMain" runat="server">
				<h2>Serial Number:
					<asp:Literal runat="server" ID="ltCard"></asp:Literal>
				</h2>
				<p>
					<asp:Label runat="server" Text="<%$Tokens:StringResource, admin.editgiftcard.ClickHere %>" />
					<asp:HyperLink ID="lnkUsage" runat="server" Text="here"></asp:HyperLink>.
				</p>
				<table class="table">
					<tr>
						<td>
							<asp:Label ID="lblAction" runat="server" Text="<%$Tokens:StringResource, admin.editgiftcard.Action %>"></asp:Label>
						</td>
						<td>
					...
					<tr runat="server" id="PurchasedByCustomerIDLiteralRow">
						...
						<td>
							<asp:Literal ID="ltCustomerEmail" runat="server"></asp:Literal>
							[ID:
