<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderoption.aspx.cs" Inherits="AspDotNetStorefrontAdmin.OrderOption" MasterPageFile="~/App_Templates/Admin_Default/AdminMaster.master" %>
			...
			<div id="divEditOrderOption" class="white-ui-box">
				<div class="row">
					<div class="col-md-4">
						...
						<div class="form-inline">
							<span class="text-danger">*</span><asp:Label AssociatedControlID="cbxDefaultisChecked" for="cbxDefaultisChecked" runat="server" Text="<%$Tokens:StringResource, admin.editorderoption.DefaultIsChecked %>" />
							<asp:CheckBox ID="cbxDefaultisChecked" Checked="true" runat="server" />
						</div>
