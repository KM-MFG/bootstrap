			...
			<div class="white-ui-box">
					...
					<table class="table">
						<tr id="generalSettings">
							<td class="white-box-heading configWizardHeader" colspan="2"><h2><asp:Label ID="Label5" runat="server" Text="<%$Tokens:StringResource, admin.wizard.GeneralSettings %>" /></h2></td>
							</tr>
							<tr>
							<td align="right">
						...
						<tr id="fraudSolutions">
							<td class="white-box-heading configWizardHeader" colspan="2"><h2><asp:Label ID="Label6" runat="server" Text="<%$Tokens:StringResource, admin.wizard.FraudSolutions %>" /></h2></td>
												</tr>
												<tr id="trMaxMind">
							<td align="right">
														<div class="configTitle">
						...
						<tr id="country">
							<td class="white-box-heading configWizardHeader" colspan="2"><h2><asp:Label ID="Label7" runat="server" Text="<%$Tokens:StringResource, admin.wizard.ChooseCountry %>" /></h2></td>
												</tr>
												<tr>
													<td align="right">
														<div class="configTitle">
						...
						<tr id="alternativePaymentMethods">
							<td class="white-box-heading configWizardHeader" colspan="2"><h2><asp:Label ID="Label8" runat="server" Text="<%$Tokens:StringResource, admin.wizard.AltPayment %>" /></h2></td>
												</tr>
							...
							<td align="right">
										...
										<table class="table">
												...
												<td>See <a href="http://www.aspdotnetstorefront.com/linkmanager.aspx?topic=9500manual&type=paypalexpress" target="_blank">Manual</a> and <a href="http://www.aspdotnetstorefront.com/linkmanager.aspx?topic=paypalexpress&type=demo" target="_blank">Demo</a>
																		</td>
						...
						<tr id="paymentMethods">
							<td class="white-box-heading configWizardHeader" colspan="2"><h2><asp:Label ID="Label10" runat="server" Text="<%$Tokens:StringResource, admin.wizard.PaymentMethods %>" /></h2></td>
												</tr>
							...
							<td align="right">
										...
										<table class="table">
												...
												<td>See <a href="http://www.aspdotnetstorefront.com/linkmanager.aspx?topic=9500manual&type=paypalstandard" target="_blank">Manual</a> and <a href="http://www.aspdotnetstorefront.com/linkmanager.aspx?topic=paypalstandard&type=demo" target="_blank">Demo</a>
																		</td>
																		<td class="paymentRightCell">
																	...
																	<tr>
																		<td class="configSelect">
													<asp:CheckBox CssClass="paymentCheckBox" ID="cbxCODMoneyOrder" runat="server" Text="C.O.D. (Money Order)" />
												</td>
												<td class="configImage"></td>
												<td>&nbsp;</td>
												<td class="paymentRightCell">&nbsp;</td>
											...
											<tr>
												<td class="configSelect">
													<asp:CheckBox CssClass="paymentCheckBox" ID="cbxCODCompanyCheck" runat="server" Text="C.O.D. (Company Check)" />
												</td>
												<td class="configImage"></td>
												<td>&nbsp;</td>
												<td class="paymentRightCell">&nbsp;</td>
											...
											<tr>
												<td class="configSelect">
													<asp:CheckBox CssClass="paymentCheckBox" ID="cbxCODNet30" runat="server" Text="C.O.D. (Net 30)" />
												</td>
												<td class="configImage"></td>
												<td>&nbsp;</td>
												<td class="paymentRightCell">&nbsp;</td>
											...
											<tr>
												<td class="configSelect">
													<asp:CheckBox CssClass="paymentCheckBox" ID="cbxECheck" runat="server" Text="E-Checks through supported gateway" />
																		...
																		<td class="configImage"></td>
												<td>See <a href="http://www.aspdotnetstorefront.com/linkmanager.aspx?topic=9500manual&type=echecks" target="_blank">Manual</a> for supported gateways
																		</td>
																		<td class="paymentRightCell">&nbsp;</td>
																	</tr>
																	<tr>
																		...
																		<td class="configImage"></td>
												<td>See <a href="http://www.aspdotnetstorefront.com/linkmanager.aspx?topic=9500manual&type=micropay" target="_blank">Manual</a>
																		</td>
																		<td class="paymentRightCell">
						...
						<tr id="paymentGateways">
							<td class="white-box-heading configWizardHeader" colspan="2"><h2><asp:Label ID="Label9" runat="server" Text="<%$Tokens:StringResource, admin.wizard.PaymentSolutions %>" /></h2></td>
												</tr>
												<tr id="trGateways">
							<td align="right">
														<div class="configTitle">
