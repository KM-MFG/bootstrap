<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newseditor.aspx.cs" Inherits="AspDotNetStorefrontAdmin.NewsEditor" MasterPageFile="~/App_Templates/Admin_Default/AdminMaster.master" %>
				...
				<div class="row">
					<div class="col-md-4">
						...
						<div class="form-group">
							...
							<asp:TextBox ID="txtCopy" runat="server" Visible="false" TextMode="MultiLine" Rows="10" />
