<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fraudorders.aspx.cs" Inherits="AspDotNetStorefrontAdmin.fraudorders" MaintainScrollPositionOnPostback="true" MasterPageFile="~/App_Templates/Admin_Default/AdminMaster.master" EnableEventValidation="false" %>
...
<asp:Content runat="server" ContentPlaceHolderID="bodyContentPlaceholder">
	...
	<div class="admin-module">
		<aspdnsf:FilteredListing runat="server"
			ID="FilteredListing"
			SqlQuery="select {0} OrderNumber, OrderDate, OrderTotal, Email, FirstName, LastName, Orders.StoreId, Store.Name [StoreName] FROM Orders left join Store on Orders.StoreID = Store.StoreID WHERE {1}"
