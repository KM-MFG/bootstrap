<%@ Page Title="<%$Tokens:StringResource, admin.common.Products %>" Language="C#" MasterPageFile="~/App_Templates/Admin_Default/AdminMaster.master" Theme="Admin_Default" CodeFile="products.aspx.cs" Inherits="AspDotNetStorefrontAdmin.Products" %>
