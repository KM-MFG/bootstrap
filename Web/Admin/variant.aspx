<%@ Page Language="C#" AutoEventWireup="true" CodeFile="variant.aspx.cs" Inherits="AspDotNetStorefrontAdmin.variant" MasterPageFile="~/App_Templates/Admin_Default/AdminMaster.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceholder" runat="server">
			...
			<div class="tabcontainer" style="clear: left;">
				...
				<div class="tab-content white-ui-box">
					<div class="tab-pane active" id="main-tab">
						<div class="admin-row">
							<table class="table table-detail">
								...
								<tr id="trShipSeparately" runat="server" class="shipping-fields" style="display: none;">
									<td>
					...
					<div class="tab-pane" id="recurring-tab">
						<div class="admin-row">
							<asp:Image runat="server" ID="imgAuthnet" ImageUrl="Images/authorizenet.gif" />
						...
						<div class="admin-row" runat="server" id="trRecurringType">
							...
							<div class="col-sm-9">
								<asp:DropDownList ID="ddRecurringInterval" CssClass="text-xs" runat="server" />
							</div>
						</div>
					</div>
	...
	<script>
		...
		$(function () {
			var shippingAreas = $('.shipping-fields');

			if ($('#rblFreeShipping input:checked').val() === '0') {
				shippingAreas.show();
			}

			$('#rblFreeShipping input').click(function (event) {
				if ($(this).val() === '0') {
					shippingAreas.show('500');
				}
				else {
					shippingAreas.hide();
				}
