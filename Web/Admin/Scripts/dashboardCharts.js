...
function updateOrdersChart(length) {
	d3.json("dashboardstatistics.ashx?type=orders&length=" + length, function (error, data) {
		var orderData = [
			{
				values: data.data,
				key: 'Revenue',
...
function updateProductsChart(length) {
	d3.json("dashboardstatistics.ashx?type=products&length=" + length, function (error, data) {
		var productData = [
			{
				values: data.data,
				key: 'Revenue',
