        ...
        private void ProcessAccountUpdate()
        {
            ...
            if (Page.IsValid && a.AffiliateID != -1)
            {
                try
                {
                    ...
                    a.Update(EMail.Text.ToLowerInvariant().Trim(), pwd, null, CommonLogic.IIF(CommonLogic.FormCanBeDangerousContent("URL").Length == 0, 0, 1), CommonLogic.Left(FirstName.Text, 50), CommonLogic.Left(LastName.Text, 50), CommonLogic.Left(Name, 100), Company.Text, Address1.Text.Replace("\x0D\x0A", ""), Address2.Text.Replace("\x0D\x0A", ""), Suite.Text, City.Text, State.SelectedValue, Zip.Text, Country.SelectedValue, AppLogic.MakeProperPhoneFormat(Phone.Text), WebSiteName.Text, WebSiteDescription.Text, theUrl2, null, null, null, null, null, null, null, null, null, null, null, null, null, saltkey);
