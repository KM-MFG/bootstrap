    ...
    <ContentTemplate>
        <asp:Panel runat="server" ID="PanelLoginWrap">
            <asp:Panel ID="PanelUsername" runat="server">
                <div class="form login-form">
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator runat="server" CssClass="opc-error-adjustments error-wrap" ID="RFVEmailAddress" ControlToValidate="txtEmailAddress"
                            ErrorMessage='<%# StringResourceProvider.GetString("smartcheckout.aspx.81") %>' Display="Dynamic"
                            EnableClientScript="true" ValidationGroup="VGAccount" Enabled="true" />
                        <aspdnsf:EmailValidator runat="server" CssClass="opc-error-adjustments error-wrap" ID="REEmailAddress" ControlToValidate="txtEmailAddress"
                    ...
                    <div class="form-group" runat="server" id="trConfirmEmail">
                        ...
                        <asp:RequiredFieldValidator runat="server" CssClass="opc-error-adjustments error-wrap" ID="RFVConfirmEmailAddress" ControlToValidate="txtConfirmEmailAddress"
                            ErrorMessage='<%# StringResourceProvider.GetString("smartcheckout.aspx.81") %>' Display="Dynamic"
                            EnableClientScript="true" ValidationGroup="VGAccount" Enabled="true" />
						<aspdnsf:EmailValidator ID="REConfirmEmailAddress" CssClass="opc-error-adjustments error-wrap" ControlToValidate="txtConfirmEmailAddress" 
							ErrorMessage='<%# StringResourceProvider.GetString("smartcheckout.aspx.82") %>' 
							ValidationGroup="VGAccount" Display="Dynamic" runat="server" Enabled="true" />
                        <asp:CompareValidator ID="CmpConfirmEmailAddress" CssClass="opc-error-adjustments error-wrap" runat="server" ErrorMessage='<%# StringResourceProvider.GetString("smartcheckout.aspx.emailsdontmatch") %>'
                            ControlToValidate="txtConfirmEmailAddress" ControlToCompare="txtEmailAddress" Display="Dynamic"
                            EnableClientScript="true" ValidationGroup="VGAccount" Enabled="true"></asp:CompareValidator>
                    </div>
                </div>
            ...
            <asp:Panel ID="PanelPassword" runat="server" DefaultButton="btnPasswordSubmit">
                <div class="form login-form">
					<div class="form-text">
                        <asp:LinkButton ID="ButtonForgotPassword" runat="server" Text='<%# StringResourceProvider.GetString("smartcheckout.aspx.87") %>' OnClick="ButtonForgotPassword_Click" />
                    </div>
					<asp:Panel CssClass="opc-error-adjustments error-wrap" ID="LostPasswordResults" runat="server" Visible="false">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox runat="server" ID="txtPassword" TextMode="Password" CssClass="form-control" ValidationGroup="VGAccount" TabIndex="2" />
						<asp:Panel ID="PanelError" runat="server" Visible="true">
							<asp:Label runat="server" CssClass="opc-error-adjustments error-wrap" ID="lblError" />
						</asp:Panel>  						
                    </div>      
                </div>			
                <div class="next-step-wrap">                    
                    <asp:Button runat="server" ID="btnPasswordSubmit" CssClass="button opc-button" Text='<%# StringResourceProvider.GetString("smartcheckout.aspx.138") %>' OnClick="btnPasswordSubmit_Click" ValidationGroup="VGAccount" TabIndex="3" />
            ...
            <asp:Panel ID="PanelCreateNewPassword" runat="server" Visible="false">
                <div class="form login-form">
                    ...
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator runat="server" CssClass="opc-error-adjustments error-wrap" ID="RFVCreateNewPassword" ControlToValidate="TextBoxNewPassword1"
                            ErrorMessage='<%# StringResourceProvider.GetString("smartcheckout.aspx.74") %>' Display="Dynamic" EnableClientScript="true"
                            ValidationGroup="VGCreateNewPassword" Enabled="true" />
                        <asp:RegularExpressionValidator ID="valPasswordMinLength" runat="server" CssClass="opc-error-adjustments error-wrap" ControlToValidate="TextBoxNewPassword1"
                            Display="Dynamic" EnableClientScript="true" ValidationGroup="VGCreateNewPassword"
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox runat="server" ID="TextBoxNewPassword2" TextMode="Password" CssClass="form-control"
                            ValidationGroup="VGCreateNewPassword" />
                        <asp:RequiredFieldValidator runat="server" CssClass="opc-error-adjustments error-wrap" ID="RFVCreateNewPasswordConfirm" ControlToValidate="TextBoxNewPassword2"
                            ErrorMessage='<%# StringResourceProvider.GetString("smartcheckout.aspx.78") %>' Display="Dynamic" EnableClientScript="true"
                            ValidationGroup="VGCreateNewPassword" Enabled="true" />
                        <asp:CompareValidator ID="CompareValidatorCreateAccountPassword" runat="server" CssClass="opc-error-adjustments error-wrap" ErrorMessage='<%# StringResourceProvider.GetString("smartcheckout.aspx.79") %>'
                            ControlToValidate="TextBoxNewPassword2" ControlToCompare="TextBoxNewPassword1"
