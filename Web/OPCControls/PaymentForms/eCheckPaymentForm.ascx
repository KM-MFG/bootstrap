            ...
            <asp:Panel ID="PanelECheckDetails" runat="server" DefaultButton="BtnSaveECheckPaymentForm">
                ...
                <div class="form e-check-form">
                    ...
                    <div class="form-submit-wrap">
                        <asp:Button ID="BtnSaveECheckPaymentForm" Text='<%# StringResourceProvider.GetString("smartcheckout.aspx.120") %>' runat="server" CssClass="button opc-button" OnClick="BtnSaveECheckPaymentForm_Click" />
                    </div>
