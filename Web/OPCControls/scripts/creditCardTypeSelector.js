    ...
    issueBoxId, securityCodeId, ccNumberId)
{
	...
	if(ccNumber.value.length >= 4)
	{
		...
		// Set default length for all CCs
		...
		{
			if (ccNumberFormatted.length > 17)
			{
				var numberOfExtraDigits = ccNumberFormatted.length - 17;
				ccNumberFormatted = ccNumberFormatted.substring(0, ccNumberFormatted.length - numberOfExtraDigits);
			}
		}
		else
		{
			if (ccNumberFormatted.length > 19)
			{
				var numberOfExtraDigits = ccNumberFormatted.length - 19;
				ccNumberFormatted = ccNumberFormatted.substring(0, ccNumberFormatted.length - numberOfExtraDigits);
			}
		}
