...
public partial class OPCControls_AddressBook : 
    ...
    IAccountView
{
	readonly bool RequireSameBillingAndShippingAddress;

	public OPCControls_AddressBook()
	{
		RequireSameBillingAndShippingAddress = !AppLogic.AppConfigBool("AllowShipToDifferentThanBillTo");
	}
	...
	protected void DataListAddressBook_OnItemCommand(object source, DataListCommandEventArgs e)
	{
		...
		if(AddressType == Vortx.OnePageCheckout.Models.AddressType.Billing || RequireSameBillingAndShippingAddress)
		{
			this.Model.PrimaryBillingAddressId = addressId;
		}

		if(AddressType == Vortx.OnePageCheckout.Models.AddressType.Shipping || RequireSameBillingAndShippingAddress)
		{
