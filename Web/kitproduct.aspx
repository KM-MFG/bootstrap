...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="PageContent">
	<asp:Panel ID="pnlContent" runat="server">
		<asp:UpdatePanel ID="pnlUpdateSummary" runat="server" UpdateMode="Always">
			<ContentTemplate>
				<asp:Literal ID="litTempFileStub" runat="server" />
				<asp:Literal ID="litKitHeader" runat="server" />
				<asp:Label ID="ltKitError" CssClass="out-stock-hint" runat="server" />				
					...
					<div class="three-fourths one-kit-column-content">						
						<div class="kit-groups">
							...
							<asp:Repeater ID="rptKitGroups" runat="server">
								<ItemTemplate>
									<aspdnsf:GroupTemplate ID="ctrlKitGroupTemplate" runat="server" ThisCustomer='<%# ThisCustomer %>' KitGroup='<%# Container.DataItemAs<KitGroupData>() %>' />
								</ItemTemplate>
							</asp:Repeater>
						</div>
					</div>
									...
									<asp:Panel ID="pnlAddToCart" runat="server" Visible="true">
										<div class="form-group kit-add-to-cart">
											<span class="kit-add-to-cart-quantity">
												...
												<asp:TextBox ID="txtQuantity" runat="server" Text="1" CssClass="form-control quantity-box" MaxLength="3" />
