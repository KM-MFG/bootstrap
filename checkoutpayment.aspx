		...
		<div class="page-wrap payment-page">
			...
			<asp:Panel ID="pnlNoPaymentRequired" runat="server" Visible="false">
				<div class="page-row no-payment">
					...
					<asp:Button ID="btnContinueCheckOut1" runat="server" Text="<%$ Tokens:StringResource,checkoutpayment.aspx.18 %>" CssClass="button call-to-action" OnClick="btnContinueCheckOut1_Click" />
				</div>
			</asp:Panel>

			<asp:Panel ID="pnlPaymentOptions" runat="server" HorizontalAlign="left" Visible="true">
				<div class="page-row payment-row">
					...
					<asp:Panel ID="pnlContCheckout" runat="server" Visible="true">
						<asp:Button ID="btnContCheckout" runat="server" CssClass="button call-to-action"
