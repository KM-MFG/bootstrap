...
namespace AspDotNetStorefrontCore
{
    public static class PromotionManager
    {
        ...
        {
            IQueryable<PromotionsData.PromotionUsage> promotionUsages = GetPromotionUsagesByCustomer(customerId);
        ...
        public static IDiscountResult GetPromotionDiscount(IRuleContext ruleContext, out IList<IDiscountResult> discountResults)
        {
            ...
            IQueryable<PromotionsData.PromotionUsage> promotionUsages = GetPromotionUsagesByCustomer(ruleContext.CustomerId);
            ...
            foreach (KeyValuePair<IPromotionUsage, IPromotionDiscount> discountPair in sortedPromotionDiscounts)
            {
                ...
                IDiscountResult discountResult = promotionController.ApplyPromotion(discountPair.Key, promotionRuleContext, promotionDiscountContext, () => new SimpleDiscountResult(), CreatePromotionController());
        ...
        {
            string excludeConfig = AppLogic.AppConfig("Promotions.ExcludeStates");
            ...
            var ruleContext = new SimpleRuleContext
            {
                ...
                MultiShipEnabled = AppLogic.AppConfigBool("AllowMultipleShippingAddressPerOrder"),
