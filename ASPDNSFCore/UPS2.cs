...
namespace AspDotNetStorefrontCore
{
    public partial class RTShipping
    {
        ...
        private void UPS2GetRates(Packages Shipment, out string RTShipRequest, out string RTShipResponse, Decimal MarkupPercent, decimal ShipmentValue, decimal ShippingTaxRate)
        {
            Shipments AllShipments = new Shipments();
            AllShipments.AddPackages(Shipment);

            UPS2GetRates(AllShipments, out RTShipRequest, out RTShipResponse, MarkupPercent, ShipmentValue, ShippingTaxRate);
        ...
        public void UPS2GetRates(Shipments AllShipments, out string RTShipRequest, out string RTShipResponse, Decimal MarkupPercent, decimal ShipmentValue, decimal ShippingTaxRate)
        {
