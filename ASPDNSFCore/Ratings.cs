			...
			using(SqlConnection conn = new SqlConnection(DB.GetDBConn()))
			{
				...
				using(SqlCommand cmd = new SqlCommand())
				{
					...
					if(productRating != 0)
					{
						...
						{
							tmpS.Append("<div class=\"rating-link-wrap\">");
							tmpS.Append("   <a class=\"button\" href=\"" + rateScript + "\">" + AppLogic.GetString("ratings.cs.25", SkinID, Thread.CurrentThread.CurrentUICulture.Name) + "</a> ");
					...
					else
					{
						...
						{
							tmpS.Append("<div class=\"rating-link-wrap\">");
							tmpS.Append("   <a class=\"button\" href=\"" + rateScript + "\">" + AppLogic.GetString("image.altText.10", SkinID, Thread.CurrentThread.CurrentUICulture.Name) + "</a>");
							tmpS.Append("</div>");
							tmpS.Append("<div class=\"rating-link-wrap\">");
							tmpS.Append("   <a class=\"button\" href=\"" + rateScript + "\">" + AppLogic.GetString("ratings.cs.28", SkinID, Thread.CurrentThread.CurrentUICulture.Name) + "</a> ");
