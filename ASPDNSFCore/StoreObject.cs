        ...
        public bool ProductionURILicensed
        {
            get
            {
                if (ProductionURI == null)
                    ...
                    return AspDotNetStorefront.Licensing.DomainIsLicensed(ProductionURI);
            }
        }
        ...
        public bool StagingURILicensed
        {
            get
            {
                if (StagingURI == null)
                    ...
                    return AspDotNetStorefront.Licensing.DomainIsLicensed(StagingURI);
            }
        }
        ...
        public bool DevelopmentURILicensed
        {
            get
            {
                if (DevelopmentURI == null)
                    ...
                    return AspDotNetStorefront.Licensing.DomainIsLicensed(DevelopmentURI);
            }
        }
