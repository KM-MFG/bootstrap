...
namespace AspDotNetStorefrontCore
{
    ...
    public class Shipping
    {
		...
		{
			return GetActiveShippingCalculationID(AppLogic.StoreID());
		}

        static public Shipping.ShippingCalculationEnum GetActiveShippingCalculationID(int storeId)
        {
			...
			ShippingCalculationEnum storeCalcMode = GetActiveStoreShippingCalculationID(storeId);
            ...
            if (storeCalcMode == ShippingCalculationEnum.Unknown)
            {
				...
				storeCalcMode = GetActiveStoreShippingCalculationID(storeId);
            }
        ...
        /// <returns></returns>
        private static ShippingCalculationEnum GetActiveStoreShippingCalculationID(int storeId)
        {
