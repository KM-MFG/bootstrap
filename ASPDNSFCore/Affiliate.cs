...
namespace AspDotNetStorefrontCore
{
	public class Affiliate
	{
		...
		public Affiliate(int Affiliateid, Guid Affiliateguid, string Email, string Password, string Notes, bool Isonline, string Firstname, string Lastname, string Name, string Company, string Address1, string Address2, string Suite, string City, string State, string Zip, string Country, string Phone, string Websitename, string Websitedescription, string Url, int Defaultskinid, int Parentaffiliateid, int Displayorder, string Extensiondata, string Sename, string Setitle, string Sealttext, string Sekeywords, string Sedescription, bool Published, bool Wholesale, bool Deleted, DateTime Createdon)
		{
		...
		public static Affiliate CreateAffiliate(string EMail, string Password, string Notes, bool IsOnline, string FirstName, string LastName, string Name, string Company, string Address1, string Address2, string Suite, string City, string State, string Zip, string Country, string Phone, string WebSiteName, string WebSiteDescription, string URL, int DefaultSkinID, int ParentAffiliateID, int DisplayOrder, string ExtensionData, string SEName, string SETitle, string SEAltText, string SEKeywords, string SEDescription, bool Wholesale, int SaltKey)
		{
			int AffiliateID = 0;
			...
			using(SqlConnection cn = new SqlConnection(DB.GetDBConn()))
			{
				...
				using(SqlCommand cmd = new SqlCommand())
				{
					...
					{
						//TODO: removed pointless string assignment, needs rewrite to fix properly
					}
				}
