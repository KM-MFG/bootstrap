...
namespace AspDotNetStorefrontCore
{
    public class ProductVariant
    {
        ...
        public bool Create()
        {
            ...
            try
            {
                ...
                sql.Append("insert into dbo.ProductVariant(" +
					"VariantGUID" +
				   ",ProductID" +
				   ",Name" +
    ...
    public class GridProductVariant
    {
        ...
        public static List<GridProductVariant> GetVariants(int ProductID, bool includeDeleted)
        {
            ...
            String sql = "select pv.VariantID" +
				              ", pv.IsDefault" +
							  ", pv.Name" +
							  ", pv.Description" +
							  ", pv.ProductID" +
						  ...
						  "where " + "pv.ProductID=" + ProductID.ToString() + CommonLogic.IIF(includeDeleted, String.Empty, " and pv.Deleted=0");
