...
var sRsltOffset_y = 35;										// vertical position offset of result panel
var sRsltMinWidth = 700;									// minimum width of search result panel
...
var sRsltMaxDspCnt = 15; 									// max number of items displayed in search result panel
var sRsltAlign = "left"; 									// align search results panel on left/right ("left"/"right") of search input field 
var imgClass = "imgPct";  									// set the class on the images (default = "imgPct")
...
var maxListItemLength = 42;								    // maximum length of an item, at which point it is truncated and ellipses are added
var imgLabelTextLength = 14;

var sRsltCloseOnBlur = true;								// close search results panel when search field focus lost

var sAjaxUrl = "/ssAutoComplete.aspx";						// URL used to make AJAX calls to server for search results (default = /ssAutoComplete.aspx)
...
var keyDelayPauseMs = 500;                                  // key delay lag maximum milliseconds, is the max pause between keystrokes in search input field
