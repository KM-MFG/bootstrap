        ...
        <div class="opc-container-inner">
            <div class="form opc-promotions">
                <div class="form-group">
					...
					<asp:RequiredFieldValidator ID="RFVPromotionCode" runat="server" CssClass="opc-error-adjustments error-wrap" ControlToValidate="txtPromotionCode" ValidationGroup="AddPromotion" ErrorMessage="<%$ Tokens:StringResource,smartcheckout.promotion.EnterPromo %>" Display="Dynamic" />           
					<asp:Label ID="lblPromotionError" runat="Server" CssClass="opc-error-adjustments error-wrap" />
					<div class="clear"></div>
					<div class="promotionlist opc-notice-adjustments">
