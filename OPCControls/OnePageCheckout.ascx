                ...
                <div class="opc-page-column-inner">
                    ...
                    <asp:Panel runat="server" ID="PanelSubmit" CssClass="checkout-block">
                        ...
                        <div class="form-submit-wrap">
                            <asp:Button ID="SubmitOrder" runat="server" CssClass="button call-to-action opc-button" OnClientClick="doSubmit(this); return false;" Text='<%# StringResourceProvider.GetString("smartcheckout.aspx.133") %>' OnClick="SubmitOrder_OnClick" />
                        </div>
                    </asp:Panel>
                </div>
            </div>
