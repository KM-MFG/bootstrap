    ...
    IAccountView
{
    ...
    public override void BindView()
    {
		...
		this.BillSameYes.Checked = this.Model.ShippingRequired && (this.Model.BillingEqualsShipping || this.Model.PrimaryBillingAddressId == this.Model.PrimaryShippingAddressId);
