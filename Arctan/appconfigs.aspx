<%@ Page Title="<%$Tokens:StringResource, admin.title.appconfigs %>" Theme="Admin_Default" Language="C#" CodeFile="appconfigs.aspx.cs" Inherits="AspDotNetStorefrontAdmin.AppConfigs" MasterPageFile="~/App_Templates/Admin_Default/AdminMaster.master" %>
