...
namespace AspDotNetStorefrontAdmin
{
	...
	/// </summary>
	public partial class country : AdminPageBase
	{
		int CountryId = 0;
		...
		private void PopulateForm(bool editing)
		{
			...
			else
			{
				...
				string sql = "SELECT * FROM Country WITH (NOLOCK) WHERE CountryID = @CountryID";
				List<SqlParameter> sqlParams = new List<SqlParameter> { new SqlParameter("@CountryID", CountryId.ToString()) };
