<%@ Page Language="c#" Inherits="AspDotNetStorefrontAdmin.currencies" CodeFile="currencies.aspx.cs" MaintainScrollPositionOnPostback="true" MasterPageFile="~/App_Templates/Admin_Default/AdminMaster.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="bodyContentPlaceholder">
	<div id="container">
		...
		<div class="white-ui-box">
				...
				<Columns>
					...
					<asp:TemplateField HeaderText="<%$ Tokens:StringResource, admin.common.name %>">
						<ItemTemplate>
							...
							<asp:RequiredFieldValidator runat="server" ControlToValidate="txtName" ErrorMessage="*Required" ValidationGroup="gAdd" Display="Dynamic" CssClass="text-danger" />
						</ItemTemplate>
						<ItemStyle Width="8%" />
					</asp:TemplateField>
					...
					<asp:TemplateField HeaderText="<%$ Tokens:StringResource, admin.currencies.Code %>">
						<ItemTemplate>
							...
							<asp:RequiredFieldValidator runat="server" ControlToValidate="txtCode" ErrorMessage="*Required" ValidationGroup="gAdd" Display="Dynamic" CssClass="text-danger" />
						</ItemTemplate>
						<ItemStyle Width="8%" />
					</asp:TemplateField>
					...
					<asp:TemplateField HeaderText="<%$ Tokens:StringResource, admin.currencies.ExchangeRate %>">
						<ItemTemplate>
							...
							<asp:RequiredFieldValidator runat="server" ControlToValidate="txtRate" ErrorMessage="*Required" ValidationGroup="gAdd" Display="Dynamic" CssClass="text-danger" />
							<asp:CompareValidator runat="server" Type="Double" Operator="DataTypeCheck" ControlToValidate="txtRate" ErrorMessage="*Please enter a decimal value" ValidationGroup="gAdd" Display="Dynamic" CssClass="text-danger" />
						</ItemTemplate>
						<ItemStyle Width="8%" />
					</asp:TemplateField>
					...
					<asp:TemplateField HeaderText="<%$ Tokens:StringResource, admin.currencies.DisplaySpec %>">
						<ItemTemplate>
							<asp:TextBox ID="txtDisplaySpec" Text='<%# Eval("DisplaySpec") %>' runat="Server" CssClass="form-control" ValidationGroup="gAdd"></asp:TextBox>
						</ItemTemplate>
					</asp:TemplateField>
					...
					<asp:TemplateField HeaderText="<%$ Tokens:StringResource, admin.common.DisplayOrder %>">
						<ItemTemplate>
							<asp:TextBox ID="txtDisplayOrder" Text='<%# Eval("DisplayOrder") %>' runat="Server" CssClass="form-control" ValidationGroup="gAdd"></asp:TextBox>
							<asp:RequiredFieldValidator runat="server" ControlToValidate="txtDisplayOrder" ErrorMessage="*Required" ValidationGroup="gAdd" Display="Dynamic" CssClass="text-danger" />
							<asp:CompareValidator runat="server" Type="Integer" Operator="DataTypeCheck" ControlToValidate="txtDisplayOrder" ErrorMessage="*Please enter an integer" ValidationGroup="gAdd" Display="Dynamic" CssClass="text-danger" />
						</ItemTemplate>
						<ItemStyle Width="8%" />
					</asp:TemplateField>
			...
			<table id="tblNewRow" runat="server" class="table table-detail">
				<tr runat="server" visible="false" id="tblNewRowHeader">
					<th>&nbsp;</th>
					<th><asp:Literal runat="server" Text="<%$ Tokens:StringResource, admin.common.name %>" /></th>
					<th><asp:Literal runat="server" Text="<%$ Tokens:StringResource, admin.currencies.Code %>" /></th>
					<th><asp:Literal runat="server" Text="<%$ Tokens:StringResource, admin.currencies.ExchangeRate %>" /></th>
					<th><asp:Literal runat="server" Text="<%$ Tokens:StringResource, admin.currencies.DisplayLocale %>" /></th>
					<th><asp:Literal runat="server" Text="<%$ Tokens:StringResource, admin.currencies.DisplaySpec %>" /></th>
					<th><asp:Literal runat="server" Text="<%$ Tokens:StringResource, admin.common.Published %>" /></th>
					<th><asp:Literal runat="server" Text="<%$ Tokens:StringResource, admin.currencies.LastUpdatedOn %>" /></th>
					<th><asp:Literal runat="server" Text="<%$ Tokens:StringResource, admin.common.DisplayOrder %>" /></th>
					<th>&nbsp;</th>
				</tr>
				<tr>
					<td style="width:68px;"><asp:Literal runat="server" Text="New:" /></td>
					<td style="width:8%;">
					...
					<td style="width:8%;">
						...
						<asp:CompareValidator runat="server" Type="Double" Operator="DataTypeCheck" ValidationGroup="gAdd" ControlToValidate="txtNewExchangeRate" ErrorMessage="*Please enter a decimal value" Display="Dynamic" CssClass="text-danger" />
					</td>
					<td>
					...
					<td style="width:8%;">
						...
						<asp:CompareValidator runat="server" Type="Integer" Operator="DataTypeCheck" ValidationGroup="gAdd" ControlToValidate="txtNewDisplayOrder" ErrorMessage="*Please enter an integer" Display="Dynamic" CssClass="text-danger" />
					</td>
			...
			<asp:Button runat="server" CausesValidation="true" ValidationGroup="gAdd" ID="btnSaveCurrencies" OnClick="btnSaveCurrencies_Click" Text="<%$Tokens:StringResource, admin.common.Save %>" CssClass="btn btn-primary" />
		</div>
		...
		<asp:Panel runat="server" ID="pnlMultipleCurrencies" Visible="false">
			...
			<div class="white-ui-box">
				<div class="white-box-heading">
					<asp:Literal runat="server" Text="Conversion Test" />
				</div>

				<asp:Literal runat="server" Text="Test Amount:" />
			...
			<div class="white-ui-box">
				<div class="white-box-heading">
					<asp:Literal runat="server" Text="Live Rates (Advanced)" />
				</div>
				<div class="row">
					<div class="col-md-2">
