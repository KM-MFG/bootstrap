...
namespace AspDotNetStorefrontAdmin
{
	public partial class SystemLog : AdminPageBase
	{
		...
		protected void btnExport_Click(Object sender, EventArgs e)
		{
			...
			Response.Write("\r\n");
			Response.Write("----------------------LICENSE INFO----------------------\r\n");
			Response.Write("\r\n");
			Response.Write("License Status:     " + AspDotNetStorefront.Licensing.LicenseInfo("status") + "\r\n");
			Response.Write("----------------------\r\n");
			Response.Write("Current Page:       " + CommonLogic.GetThisPageName(true) + "\r\n");
			Response.Write("----------------------\r\n");
			Response.Write("License ID:         " + AspDotNetStorefront.Licensing.LicenseInfo("id") + "\r\n");
			Response.Write("----------------------\r\n");
			Response.Write("License Created:    " + AspDotNetStorefront.Licensing.LicenseInfo("createdon") + "\r\n");
			Response.Write("----------------------\r\n");
			Response.Write("Licensed To:        " + AspDotNetStorefront.Licensing.LicenseInfo("licensename") + "\r\n");
			Response.Write("----------------------\r\n");
			Response.Write("License Version:    " + AspDotNetStorefront.Licensing.LicenseInfo("licenseversion") + "\r\n");
			Response.Write("----------------------\r\n");
			Response.Write("License Domain:     " + AspDotNetStorefront.Licensing.LicenseInfo("licensedomains") + "\r\n");
			Response.Write("----------------------\r\n");
			Response.Write("Assembly Name:      " + AspDotNetStorefront.Licensing.LicenseInfo("assemblyname") + "\r\n");
			Response.Write("----------------------\r\n");
			Response.Write("Assembly Versions:  " + AspDotNetStorefront.Licensing.LicenseInfo("assemblyversion") + "\r\n");
			Response.Write("----------------------\r\n");
			Response.Write("Assemnbly Domain:   " + AspDotNetStorefront.Licensing.LicenseInfo("assemblydomain") + "\r\n");
			Response.Write("----------------------\r\n");
			Response.Write("Product Level:      " + AspDotNetStorefront.Licensing.LicenseInfo("productlevel") + "\r\n");
			Response.Write("----------------------\r\n");
			Response.Write("Is ML:              " + AspDotNetStorefront.Licensing.LicenseInfo("productisml") + "\r\n");
			Response.Write("\r\n");
