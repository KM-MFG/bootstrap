<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderoptions.aspx.cs" Inherits="AspDotNetStorefrontAdmin.OrderOptions"
...
<asp:Content runat="server" ContentPlaceHolderID="bodyContentPlaceholder">
	...
	<aspdnsf:FilteredListing runat="server"
		ID="FilteredListing"
		SqlQuery="SELECT {0} OrderOption.OrderOptionID, dbo.GetMlValue(OrderOption.Name, @_locale) OptionName, OrderOption.Cost, OrderOption.Description, OrderOption.DisplayOrder, OrderOption.DefaultIsChecked, OrderOption.CreatedOn, dbo.GetMlValue(TaxClass.Name, @_locale) TaxName 
		...
		<Filters>
			...
			<aspdnsf:BooleanFilter runat="server" Label="Default Is Checked" FieldName="DefaultIsChecked" />
		</Filters>
		<ListingTemplate>
			<div class="white-ui-box">
				<asp:GridView CssClass="table" ID="gMain" runat="server"
					...
					<Columns>
						...
						<asp:TemplateField
							HeaderText="Default is Checked"
							ItemStyle-Width="8%">
							<ItemTemplate>
								<%# (byte)DataBinder.Eval(Container.DataItem, "DefaultIsChecked") == 1 
								? AppLogic.GetString("admin.common.yes", AppLogic.GetCurrentCustomer().LocaleSetting)
								: AppLogic.GetString("admin.common.no", AppLogic.GetCurrentCustomer().LocaleSetting) %>
							</ItemTemplate>
						</asp:TemplateField>
