...
<asp:Content runat="server" ContentPlaceHolderID="bodyContentPlaceholder">
	<asp:Panel ID="pnlBillMeLater" runat="server" DefaultButton="btnSaveConfigurationTop">
		...
		<h1>
			...
			<asp:Literal ID="Literal1" runat="server" Text="<%$ Tokens:StringResource, admin.menu.PayPalBillMeLater %>" />
		</h1>
		<div>
