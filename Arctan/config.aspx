<%@ Page Title="<%$Tokens:StringResource, admin.title.appconfig %>" Theme="Admin_Default" Language="C#" CodeFile="config.aspx.cs" Inherits="AspDotNetStorefrontAdmin.ConfigEditor" MasterPageFile="~/App_Templates/Admin_Default/AdminMaster.master" %>
