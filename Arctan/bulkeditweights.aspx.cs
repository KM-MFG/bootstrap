...
public partial class _bulkeditweights : AdminPageBase
{
	...
	{
		StringBuilder exportContents = new StringBuilder("ProductID,ProductName,VariantID,VariantName,Weight,Width,Height,Depth,IsShipSeparately\r\n");
