					...
					<Columns>
						...
						<asp:TemplateField HeaderText="<%$Tokens:StringResource, admin.common.Name %>" SortExpression="Name">
							...
							<EditItemTemplate>
								...
								ex: en-US
							<asp:RequiredFieldValidator ID="RequiredFieldValidator" runat="server" ErrorMessage="<%$Tokens:StringResource, admin.common.ValidatorMessage %>" ControlToValidate="txtName"></asp:RequiredFieldValidator>
							</EditItemTemplate>
						</asp:TemplateField>
		...
		<asp:Panel ID="pnlAdd" runat="Server" DefaultButton="btnSubmit">
			<div class="white-ui-box">
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<asp:RequiredFieldValidator ErrorMessage="<%$Tokens:StringResource, admin.common.FillinName %>" CssClass="text-danger" ControlToValidate="txtName" ID="RequiredFieldValidator2" ValidationGroup="gAdd" Display="dynamic" SetFocusOnError="true" runat="server">!!</asp:RequiredFieldValidator>
							<asp:RegularExpressionValidator ErrorMessage="Validate Name" ControlToValidate="txtName" CssClass="text-danger" ID="RegularExpressionValidator" ValidationGroup="gAdd" Display="dynamic" SetFocusOnError="true" runat="server" ValidationExpression="^[a-z][a-z]-[A-Z][A-Z]$"></asp:RegularExpressionValidator>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							<asp:Literal runat="server" Text="<%$Tokens:StringResource, admin.common.Description %>" />:
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<asp:RequiredFieldValidator ErrorMessage="<%$Tokens:StringResource, admin.localesettings.SelectCurrency %>" CssClass="text-danger" InitialValue="0" ControlToValidate="ddCurrency" ID="RequiredFieldValidator1" ValidationGroup="gAdd" SetFocusOnError="true" runat="server"></asp:RequiredFieldValidator>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							...
							<asp:RequiredFieldValidator ID="RequiredFieldValidator4" CssClass="text-danger" runat="server" ErrorMessage="<%$Tokens:StringResource, admin.common.EnterDisplayOrder %>" ValidationGroup="gAdd" ControlToValidate="txtOrder"></asp:RequiredFieldValidator>
