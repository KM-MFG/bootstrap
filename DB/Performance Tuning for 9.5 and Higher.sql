...
GO
UPDATE [dbo].[Address] SET [eCheckBankABACode] = [eCheckBankABACode];
GO
UPDATE [dbo].[Address] SET [eCheckBankAccountName] = [eCheckBankAccountName];
GO
UPDATE [dbo].[Address] SET [eCheckBankAccountNumber] = [eCheckBankAccountNumber];
GO
UPDATE [dbo].[Address] SET [eCheckBankAccountType] = [eCheckBankAccountType];
GO
UPDATE [dbo].[Address] SET [eCheckBankName] = [eCheckBankName];
GO
...
GO
UPDATE [dbo].[Orders] SET [eCheckBankABACode] = [eCheckBankABACode];
GO
UPDATE [dbo].[Orders] SET [eCheckBankAccountName] = [eCheckBankAccountName];
GO
UPDATE [dbo].[Orders] SET [eCheckBankAccountNumber] = [eCheckBankAccountNumber];
GO
UPDATE [dbo].[Orders] SET [eCheckBankAccountType] = [eCheckBankAccountType];
GO
UPDATE [dbo].[Orders] SET [eCheckBankName] = [eCheckBankName];
GO
...
GO
UPDATE [dbo].[ShippingMethod] SET [ShipRushTemplate] = [ShipRushTemplate];
GO
