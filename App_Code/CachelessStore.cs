        ...
        public Boolean ProductionURILicensed
        {
            get
            {
                if (this.ProductionURI == null)
                    ...
                    return AspDotNetStorefront.Licensing.DomainIsLicensed(this.ProductionURI);
            }
        }
        ...
        public Boolean StagingURILicensed
        {
            get
            {
                if (this.StagingURI == null)
                    ...
                    return AspDotNetStorefront.Licensing.DomainIsLicensed(this.StagingURI);
            }
        }
        ...
        public Boolean DevelopmentURILicensed
        {
            get
            {
                if (this.DevelopmentURI == null)
                    ...
                    return AspDotNetStorefront.Licensing.DomainIsLicensed(this.DevelopmentURI);
            }
        }
