            ...
            if (Quantity > 0)
            {
                if (AppLogic.IsAKit(ProductID))
                {
                    ...
                    if (productIsUsingKit2XmlPackage)
                    {
                        ...
                        cart.AddItem(ThisCustomer, ShippingAddressID, ProductID, VariantID, Quantity, string.Empty, ChosenColorSKUModifier, ChosenSize, ChosenSizeSKUModifier, TextOption, CartType, false, false, System.Decimal.Zero, preferredComposition);
                    }
                    else
                    {
                        cart.AddItem(ThisCustomer, ShippingAddressID, ProductID, VariantID, Quantity, ChosenColor, ChosenColorSKUModifier, ChosenSize, ChosenSizeSKUModifier, TextOption, CartType, false, false, System.Decimal.Zero);
                    }
                }
                else
                {
                    cart.AddItem(ThisCustomer, ShippingAddressID, ProductID, VariantID, Quantity, ChosenColor, ChosenColorSKUModifier, ChosenSize, ChosenSizeSKUModifier, TextOption, CartType, false, false, CustomerEnteredPrice);
                }
            }
                        ...
                        try
                        {
                            ...
                            if (UpsellProductID != 0)
                            {
                                ...
                                if (UpsellVariantID != 0)
                                {
                                    ...
                                    cart.AddItem(ThisCustomer, ShippingAddressID, UpsellProductID, UpsellVariantID, 1, Colors, ColorSKUModifiers, Sizes, SizeSKUModifiers, String.Empty, CartType, false, false, System.Decimal.Zero);
